...
#ifdef STANDALONE
  #define PRODUCT_NAME				"ioGensokyo3"
  #define BASEGAME					"baseia"
  #define CLIENT_WINDOW_TITLE		"Illusion Arena"
  #define CLIENT_WINDOW_MIN_TITLE	"illusionarena"
  #define HOMEPATH_NAME_UNIX		".illusion"
  #define HOMEPATH_NAME_WIN			"IllusionArena"
  #define HOMEPATH_NAME_MACOSX		HOMEPATH_NAME_WIN
//  #define STEAMPATH_NAME			"Foo Bar"
//  #define STEAMPATH_APPID         ""
  #define GAMENAME_FOR_MASTER		"IllusionArena"	// must NOT contain whitespace
  #define CINEMATICS_LOGO		"iaLogo.RoQ"
  #define CINEMATICS_INTRO		"iaIntro.RoQ"
